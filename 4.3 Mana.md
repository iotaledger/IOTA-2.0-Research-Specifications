...
Suppose a node has a Base Mana Snapshot State stored, relative to time 0, and needs to update its Access Mana Vector every second $i$. To do that, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE3NzQ2MTM2OCwyMTEwMjUzMDc1LDE5MD
