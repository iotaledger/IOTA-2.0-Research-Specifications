...
Suppose a node has a Base Mana Snapshot State stored, relative to time 0, and needs to update its Access Mana Vector every second $i$, to include the Mana relative to the set of transactions $S_i$ booked in the period $[i-1,i)$. To do that, the node will call the function Get_Mana
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NTYwMDkzNTksMjExMDI1MzA3NSwxOT
AzODQ4MDk1LDIxNDcyMTU3MSwtMTgzODQ3MzI2NCwtOTI0MDU4
NDUyXX0=
-->