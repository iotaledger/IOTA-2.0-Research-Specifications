...
Since this Mana will be updated frequently, we do not recomend to update the Base Mana Vectors based on the Snapshot File. Instead, a more recent Base Mana Vector should be locally stored by the components using the Access Mana and
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NTM1NzA5NDUsMjExMDI1MzA3NSwxOT
