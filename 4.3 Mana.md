...
```
Update_Snapshot_Ledger_State(Set_of_Transactions)
Update_Base_Snapshot_Mana(t,T,Set_of_Transactions,Base_Mana Snapshot State)
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ3NTc3NDkwLC0xMzA0OTc1NTQ4LDMzOT
