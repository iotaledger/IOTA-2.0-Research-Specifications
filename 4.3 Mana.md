...
* [Section 4.6 - Congestion Control](./3.4%20Congestion%20Control.md): The throughput (in bytes per second) of each node is dependent on the access Mana held.
* [Section 3.4 - Neighbor Selection](./2.2%20Neighbor%20Selection.md):  Nodes only establish a connection with nodes of similar consensus Mana.
* [Section 6.3 -  Fast Probabilistic Consensus](./5.1%20Fast%20Probabilistic%20Consensus.md): The selection probability for a node during a voting query is proportional to the consensus Mana held.
* [Section 6.6 - Decentralized Random Number Generator](./6.5%20dRNG.md): The dRNG committee members must be composed by high consensus Mana nodes.
