...
* **Neighbor Selection**: Only nodes with similar Consensus Mana will be chosen as neighbors.
* **Voting**: The voting power of a node should be proportional to the Consensus Mana.
* **dRNG**: The dRNG committee will be constituted by the high Consensus Mana nodes.
