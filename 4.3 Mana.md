...
The EMA of a function $X_t$ is defined as follow:

$$
   \text{EMA}_X(t) 
    = c \int_{-\infty}^t X_s e^{-c(t-s)}ds.
$$
...
The weighting for older datum decreases exponentially in time, however, never reaching zero. For this reason EMAs shall be  calculated recursively.
