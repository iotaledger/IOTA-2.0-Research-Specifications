...
The *Markers* tool depends on:

+ Tangle: Certain messages in the Tangle are given additional meaning in order to group subsets of messages.
+ Ledger State: New marker sequences are created when a new conflict is detected.
