...
* **UTXO branch:** This is a set of outputs that spawn off from a conflict transaction. Each UTXO branch by itself is conflict free. See also [Section 5.1 - UTXO](https://github.com/iotaledger/Coordicide-Specifications/blob/main/5.1%20UTXO.md) and [Section 5.2 - Ledger State](https://github.com/iotaledger/Coordicide-Specifications/blob/main/5.2%20Ledger%20State.md) for a more complete discussion on UTXO and its branches.
