# 2.3 Data flow
This section provides a high-level description of the interaction between components of the IOTA protocol. The protocol can be divided in three main elements: a P2P overlay network, an immutable data structure, and a consensus mechanism, which are wired together via game-theoretical and economic incentives. 
