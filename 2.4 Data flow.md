# 2.3 Data flow
This section provides a high-level description of the interaction between components of the IOTA protocol. Similarly to other DLTs, the protocol can be divided in three main elements: a P2P overlay network, an immutable data structure, and a consensus mechanism, which are wired together via game-theoretical incentives. 
