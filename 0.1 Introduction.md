...
Each node in the network has limited bandwidth, CPU, and memory.  In order for no node to be overloaded, the gossip of messages is regulated by the congestion control aglorith,
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0ODQyMzMwNzgsLTExMDM0NzA3MDAsLT
