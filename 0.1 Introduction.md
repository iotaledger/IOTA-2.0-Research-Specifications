...
The amount of mana a node has ultimately decides how many it can issue. However, because of the utilization requirement,   computing the exact aloud rate is a bit complicated.  Suppose nodes A,B,C,D each have 100 mana, and they are the only nodes issueing messages.  Then each node can issue 25% of the messages.  Now suppose, node D drops offline, then 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2ODIzODQ3NDUsMjAyMTM2MTI5OCw2Mz
