...
FPC stands for fast probabilistic consensus.  This is a binary voting protocol that allows a large grout of nodes to come to consensus on the value of a Boolean 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNzQ3MzQ0NjgsLTExNzIxNTM3NjEsMj
