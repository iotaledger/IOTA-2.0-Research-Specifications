...
The only way for a node to receive mana is to convince a token holder to pledge them mana when moving a transaction.  The arrangement between the token holder node operator can
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNzM2MDUxMDYsMjA5MzA5ODY2NCw0Nj
