...
The sybil protection mechanism used in IOTA 2.0 is called mana. Mana is an integer associated with each node, and can be thought of as extension of the ledger state, 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MjkwMjgyMjUsMjA5MzA5ODY2NCw0Nj
