...
The congestion control algorithm also uses a rate set which allows each node to set its own individual rate.  The rate setter uses a variant of AIMD algorith
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM2NzE0NDAxOCw2Mzk3OTgxMzcsLTExMD
