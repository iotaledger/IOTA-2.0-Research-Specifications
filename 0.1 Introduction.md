...
After filtering for duplicates and invalidity, a node places all the messages received in gossip into an inbox.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMzY5MzE2MzMsLTExMDM0NzA3MDAsLT
