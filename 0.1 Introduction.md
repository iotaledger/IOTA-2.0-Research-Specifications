...
When a new value object is added to the value tangle, the node must choose two other value objects for this object to reference.  A tip is a value object    This is process is called tip selection.



 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MTE3NjY1NTAsNjE5MjMzNTUxLC0xMT
