...
## The Value Transfer Application
 ...
 The amount of mana a node has, determines how it can interact with certain modules.  For example, the congestion control algorithm schedules messages according to access mana.  The consensus applications dRNG, FPC,  and approval weight all use consensus mana. The autopeering is using both types of mana.  
