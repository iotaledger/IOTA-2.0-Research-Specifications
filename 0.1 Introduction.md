...
When a new value object is added to the value tangle, the node must choose two other value objects for this object to reference.     An honest node always chooses two tips, i.e. objects unreferenced by any other value object. Thus this selectiois is process is called tip selection.



 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU1NzMwMjk4MSw2MTkyMzM1NTEsLTExNz
IxNTM3NjEsMjA5MzA5ODY2NCw0NjkwMjQ4NDIsLTcwOTE3Njc0
Miw1MjYwMDc3MDIsLTIyNjEyNjg2OSwtNDExMDU0NjM2LC0xMj
