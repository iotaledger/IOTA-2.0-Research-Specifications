...
The sybil protection mechanism used in IOTA 2.0 is called mana. Mana is a number associated with each node, and can be thought of as extension of the ledger state.  Every transaction will contain a `pleddged Node ID` field.  When a transaction is booked, 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NzAwNjI5MSwyMDkzMDk4NjY0LDQ2OT
