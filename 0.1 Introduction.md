...
The scheduler essentially acts as a gate keeper, allocating the network resources in a fair manner.  The scheduler is designed to have the following properties.  REc
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNDI0NjUxMTEsLTExMDM0NzA3MDAsLT
