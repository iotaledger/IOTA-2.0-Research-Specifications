...
Messages and branches gain approval weight. Once the approval weight exceeds a certain threshold we consider the branch as confirmed, see also section [**3.2.3.4** Finality]().
