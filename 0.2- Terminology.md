...
- **Core Application:** An application that all nodes are requried to 
    
-   All nodes must run some . Examples include the Value Transfer Application.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgyNjg4NjgyNCwxMjY1NTk3ODQ4LDI0MD
