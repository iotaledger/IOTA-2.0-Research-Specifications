...
- **Generic Data Object:** Base typ  Every payload must support the Generic Data Object type which consists of size followed by data. All unrecognised object types will be parsed as a generic data object.
    
-   A payload is empty if it contains a generic data object of size 0
    
-   The type“X payload”  payload with a type X object.
    
-  of an object always includes the version number.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI2NTU5Nzg0OCw1MDQ1ODk5ODEsMjQwND
