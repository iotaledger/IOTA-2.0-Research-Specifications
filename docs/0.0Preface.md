---
description: Research specifications of the IOTA 2.0 Protocol which carefully explain the current state of the protocol to developers, who wish to build on or test Nectar, to academics who want to analyze, model and optimize the protocol, and to community members and anybody who just want to learn more about the protocol.
