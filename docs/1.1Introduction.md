---
description: These are the research specifications for the IOTA 2.0 protocol. Chapter 1 contains control files. Chapter 2 outlines the general structure of the protocol. Chapter 3 discusses the networking layer. Chapters 4, 5, and 6 include the bulk of the protocol.
...
[![Data flow overview](/img/research-specifications/layers-overview.png)](/img/research-specifications/layers-overview.png)
  
## The communication layer
  

The communication layer manages the information communicated through the network layer, including processing information received from the gossip, storing information, checking various validity conditions, and deciding what information to send to its neighbors. 
...
## The Value Transfer Application
 ...
 The amount of mana a node has determines how it can interact with certain modules.  For example, the congestion control algorithm schedules messages according to access mana.  The consensus applications dRNG, FPC, approval weight and auto-peering all use consensus mana.
