...
Consensus matters are not discussed in this document: see sections [6.1](./6.1%20Objects%20of Consensus), [6.2](./6.2%20Opinion%20Setting) and [6.3](./6.3%20Fast%20Probabilistic%20Consensus) to discuss how FPC votes on timestamps. 
