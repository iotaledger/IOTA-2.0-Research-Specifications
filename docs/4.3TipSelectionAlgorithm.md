---
description: The tip selection algorithm is the method by which messages are selected for approval by other issued messages joining the network. It allows the Tangle to grow in a stable and secure way, with quick approval and finality times
