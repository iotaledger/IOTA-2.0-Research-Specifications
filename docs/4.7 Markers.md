...
* **UTXO branch:** This is a set of outputs that spawn off from a conflict transaction. Each UTXO branch by itself is conflict free. See also [Section 5.1 - UTXO](./5.1%20UTXO) and [Section 5.2 - Ledger State](./5.2%20Ledger%20State) for a more complete discussion on UTXO and its branches.
...
For further details about the UTXO model, please refer to the section on [UTXO](./5.1%20UTXO).
