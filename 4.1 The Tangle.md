...
Branch of a message: the branch of a message is the set of conflicts in the past cone of the message. Note that for every conflict $X$ in the past cone of a message $M$, by the past cone check rule, see Ledger state spec, every conflict $Y$ in the UTXO past cone of the $X$ is also in a message in the past cone of $M$.
