...
| -----| ------ | ----------- |
|`DLARGE` | integer | Gratuitous network delay estimate~ 15 s|
|`W` | integer | window ~1 minute. Require W>2DLARGE|
| `DELTA` | integer | max age difference in consecutive timestamps. Require DELTA>W+DLARGE|
