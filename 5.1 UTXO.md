...
The table describing the entirety of a <i>Transaction</i>'s serialized form is presented in the [Section 2.3 Standard Payloads Layout](./2.2%20Standard%20Payloads%20Layout.md#transaction-payload).

See [Data Types Notation](https://github.com/iotaledger/Coordicide-Specifications/blob/feat/datatypes-notations/2.1%20Datatypes%20and%20Notations.md)
