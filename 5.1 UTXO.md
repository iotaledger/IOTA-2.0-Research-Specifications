...
The way UTXOs are referenced is described in the following <i>Structure</i> section.
...
The <i>Transaction Essence</i> of a <i>Transaction</i> carries the inputs, outputs and an optional payload. The <i>Transaction Essence</i> is an explicit type and therefore starts with its own <i>Transaction Essence Type</i> byte which is of value 0.
...
The ID of any tokenized asset is defined by the Blake2b hash of the OutputID that created the asset.
