...
In the following subsections we will explain the details about the number of parents and the uniform selection, while the approval switch mechanism is introduced in [Section 4.1 - The Tangle](./4.1%20The%20Tangle.md#4121-approval-switch). 
