...
**Table 6.5.2.2  dRNG parameters Suggested value**

| Parameter  |      Value     |
|----------|:-------------:|
| `RNPeriod`  |  20 [sec]|
| `CommitteeNodes` |  10 [nodes]|
|  `CommitteeSeats` |  15   [seats]|
| `SigThreshold`|  8 [messages] ([seats]) |
| `CommitteeUpdate` | 1 [day] = 86400 [sec]|
|   `ApplicationWindow`   | 120 [sec] |
|  `TIMESTAMP_CUTOFF`     |  2`DLARGE` +`W`= 90[sec]|
