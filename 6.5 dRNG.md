...
2. Number of nodes in the committee: `CommitteeNodes`.  
    ...
    **Suggested value**: `CommitteeNodes` [nodes].   
...
5. Perioid of committee update: `CommPerioid`.  
      *A new committee is selected every `CommPerioid` unit of time.*  
    **Suggested value**: `CommPerioid` = 1 [day].    
