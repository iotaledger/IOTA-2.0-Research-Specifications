...
_Table 4.5.1 - Global constants._
...
_Table 4.5.2 - Local variables and metadata._
...
_Table 4.5.3 - Built-in functions._
### 4.5.3.4 Pseudocode
...
_Image 4.5.4 - Proposed data structures for the implementation of the rate control mechanism._
