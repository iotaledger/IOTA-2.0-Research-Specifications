...
The mechanisms described act as an emergency break during spam attacks, by limiting the valid messages a node can send.  For honest user Finer controls on the access are developed in Section 3.4, which regulate network traffic during normal periods of congestion.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY2ODc1OTMzLC05Nzk5MjU1MDUsLTQ4OT
